...
enum TravelRequestStatus: string
{
    ...
    case SCHEDULED = 'scheduled';                 // Viagem montada e agendada (quando linkar com TripSchedule)
    ...
    // O status COMPLETED provavelmente pertencerá à entidade TripSchedule
    ...
    public function badgeClasses(): string
    {
        return match ($this) {
            ...
            self::CANCELLED_BY_USER, self::CANCELLED_BY_ADMIN => 'bg-gray-100 text-gray-800 dark:bg-gray-600 dark:text-gray-200',
        };
    }
