    ...
    <div class="flex h-full w-full flex-1 flex-col gap-6 p-4 sm:p-6">
        ...
        <div class="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4">
            <div>
                ...
                <!--[if BLOCK]><![endif]--><?php if($pageSubtitle): ?>
                    <p class="text-sm text-gray-600 dark:text-neutral-400"><?php echo e($pageSubtitle); ?></p>
                <?php endif; ?><!--[if ENDBLOCK]><![endif]-->
            </div>

            
            <!--[if BLOCK]><![endif]--><?php if(Auth::user()->hasRole('manager') && $unitsForFilter->isNotEmpty()): ?>
                <div class="w-full sm:w-auto">
                    <label for="selectedUnitId" class="sr-only"><?php echo e(__('Filtrar por Unidade')); ?></label>
                    <select wire:model.live="selectedUnitId" id="selectedUnitId"
                        ...
                        <option value="all"><?php echo e(__('Todas as Unidades (Visão Geral)')); ?></option>
                        <!--[if BLOCK]><![endif]--><?php $__currentLoopData = $unitsForFilter; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $unit): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
        ...
        <div class="mb-8">
            ...
            <div class="grid grid-cols-1 gap-5 sm:grid-cols-2 lg:grid-cols-3">
                <!--[if BLOCK]><![endif]--><?php $__currentLoopData = $summaryCardsInfo; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $info): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    <?php $colors = getCardDashboardColors($info['color']); ?>
                    <a href="<?php echo e($info['route']); ?>" wire:navigate
                       class="block bg-white dark:bg-neutral-800 overflow-hidden shadow-lg rounded-lg
                              border-l-4 <?php echo e($colors['border']); ?>

                              hover:shadow-xl transition-shadow duration-300 ease-in-out"> 
                        <div class="p-5">
                            <div class="flex items-center">
                                <div class="flex-shrink-0 <?php echo e($colors['bg_icon']); ?> rounded-md p-3">
                                    <span class="<?php echo e($info['icon']); ?> w-6 h-6 <?php echo e($colors['text_icon']); ?>"></span>
                                </div>
                                <div class="ml-5 w-0 flex-1 rtl:ml-0 rtl:mr-5">
                                    <dl>
                                        <dt class="text-sm font-medium text-gray-500 dark:text-neutral-400 truncate" title="<?php echo e($info['label']); ?>">
                                            <?php echo e($info['label']); ?>

                                        </dt>
                                        <dd>
                                            <div class="text-2xl font-bold text-gray-900 dark:text-neutral-100">
                                                <?php echo e($info['count']); ?> 
                                            </div>
                                        </dd>
                                    </dl>
                                </div>
            ...
            <div class="grid grid-cols-1 gap-5 sm:grid-cols-3 lg:grid-cols-4 xl:grid-cols-5 mt-5">
                <!--[if BLOCK]><![endif]--><?php $__currentLoopData = $statusCardsInfo; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $info): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    <?php $colors = getCardDashboardColors($info['color']); ?>
                    <a href="<?php echo e(route('prescriptions.index', ['status' => $info['filter']])); ?>" wire:navigate
                       class="block bg-white dark:bg-neutral-800 overflow-hidden shadow-lg rounded-lg
                              border-l-4 <?php echo e($colors['border']); ?>
                        ...
                        <div class="bg-gray-50 dark:bg-neutral-700/50 px-5 py-2.5">
                            <div class="text-xs">
                                <span class="font-medium <?php echo e($colors['text_link']); ?>">
                                    Ver detalhes &rarr;
                                </span>
                            </div>
                        </div>
...
</div><?php /**PATH /var/www/html/sabio-system/resources/views/livewire/dashboard-summary.blade.php ENDPATH**/ ?>