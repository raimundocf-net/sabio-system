<div>
    ...
    <div class="space-y-6 px-4 sm:px-6 lg:px-8 py-6">
        ...
        <div class="grid grid-cols-1 md:grid-cols-3 gap-4 p-4 bg-white dark:bg-neutral-800 shadow-md sm:rounded-lg">
            ...
            <!--[if BLOCK]><![endif]--><?php if(auth()->user()->hasRole('admin') || auth()->user()->hasRole('manager')): ?>
                <div>
                    <label for="filterAcsId" class="block text-sm font-medium text-gray-700 dark:text-neutral-300"><?php echo e(__('Filtrar por Solicitante (ACS)')); ?></label>
                    <select wire:model.live="filterAcsId" id="filterAcsId"
                            class="mt-1 block w-full rounded-md border border-gray-300 dark:border-neutral-500 py-2 pl-3 pr-10 text-gray-900 dark:text-neutral-100 bg-white dark:bg-neutral-700 focus:border-indigo-500 dark:focus:border-sky-500 focus:ring-1 focus:ring-indigo-500 dark:focus:ring-sky-500 sm:text-sm">
                        <option value=""><?php echo e(__('Todos os Solicitantes ACS')); ?></option>
                        
                        <!--[if BLOCK]><![endif]--><?php $__currentLoopData = $acsUsers; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $id => $name): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <option value="<?php echo e($id); ?>"><?php echo e($name); ?></option>
                        <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?><!--[if ENDBLOCK]><![endif]-->
                    </select>
                </div>
            <?php elseif(auth()->user()->hasRole('acs')): ?>
                <div>
                    <label for="loggedInAcs" class="block text-sm font-medium text-gray-700 dark:text-neutral-300"><?php echo e(__('Suas Solicitações (ACS)')); ?></label>
        ...
        <div class="grid grid-cols-1 sm:grid-cols-3 lg:grid-cols-4 xl:grid-cols-4 gap-4">
            <!--[if BLOCK]><![endif]--><?php $__empty_1 = true; $__currentLoopData = $prescriptions; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $prescription): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                <div wire:key="prescription-card-<?php echo e($prescription->id); ?>"
                    ...
                    <div class="p-4 flex flex-col flex-grow">
                        <div class="mb-2">
                            <h3 class="text-md font-semibold text-indigo-700 dark:text-indigo-400 truncate" title="<?php echo e($prescription->citizen?->nome_do_cidadao ?? $prescription->citizen?->name); ?>">
                                <?php echo e($prescription->citizen?->nome_do_cidadao ?? $prescription->citizen?->nome_do_cidadao ?: __('Cidadão não informado')); ?>
            ...
            <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); if ($__empty_1): ?>
                <div class="col-span-full text-center py-16">
                    ...
                    <!--[if BLOCK]><![endif]--><?php if(empty($searchTerm) && empty($filterStatus) && empty($filterAcsId)): ?>
                                ...
                                <div class="mt-3 text-center sm:mt-0 sm:ml-4 sm:text-left w-full">
                                    ...
                                    <div class="mt-2">
                                        <p class="text-sm text-gray-600 dark:text-neutral-300 mb-1">
                                            <?php echo e(__('Tem certeza que deseja cancelar a solicitação para')); ?> <strong><?php echo e($cancellingPrescription->citizen?->name ?? $cancellingPrescription->citizen?->nome_do_cidadao); ?></strong>?
                                        </p>
                                        <div>
...
</div><?php /**PATH /var/www/html/sabio-system/resources/views/livewire/prescriptions/list-prescriptions.blade.php ENDPATH**/ ?>