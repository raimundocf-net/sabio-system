...
unset($__errorArgs, $__bag); ?><!--[if ENDBLOCK]><![endif]-->
                    ...
                    <div>
                        <label for="prescriptionImage" class="block text-sm font-medium leading-6 text-gray-900 dark:text-neutral-200">
                            <?php echo e(__('Anexar Imagem da Receita (Opcional)')); ?>
                        ...
                        <!--[if BLOCK]><![endif]--><?php $__errorArgs = ['prescriptionImage'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> <p class="mt-1 text-sm text-red-600 dark:text-red-400"><?php echo e($message); ?></p> <?php unset($message);
...
unset($__errorArgs, $__bag); ?><!--[if ENDBLOCK]><![endif]-->
                        ...
                        <!--[if BLOCK]><![endif]--><?php if($prescriptionImage && method_exists($prescriptionImage, 'temporaryUrl')): ?>
                            <div class="mt-4 p-2 border border-dashed border-gray-300 dark:border-neutral-600 rounded-md inline-block">
                                <p class="text-xs font-medium text-gray-700 dark:text-neutral-300 mb-1"><?php echo e(__('Pré-visualização:')); ?></p>
                                <img src="<?php echo e($prescriptionImage->temporaryUrl()); ?>" alt="<?php echo e(__('Preview da receita anexada')); ?>" class="max-h-48 w-auto rounded-md border dark:border-neutral-500">
                            </div>
                ...
                <div class="flex items-center justify-end gap-x-3 bg-gray-50 dark:bg-neutral-900/30 px-4 py-3 sm:px-6 border-t border-gray-900/10 dark:border-neutral-100/10">
                    ...
                    <button type="submit" wire:loading.attr="disabled"
                        ...
                        <span wire:loading wire:target="submitPrescriptionRequest"><?php echo e(__('Enviando...')); ?></span>
                        <span wire:loading.remove wire:target="submitPrescriptionRequest"><?php echo e(__('Enviar Solicitação')); ?></span>
                    </button>
                </div>
            </form>
            <?php else: ?>
...
</div><?php /**PATH /var/www/html/system/resources/views/livewire/prescriptions/request/prescription-form-step.blade.php ENDPATH**/ ?>