        ...
        <div class="w-full sm:flex-1 grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-5 xl:grid-cols-6 gap-3 items-end">
            <div class="lg:col-span-2 xl:col-span-2">
                ...
                <input type="text" wire:model.live.debounce.300ms="searchTerm" id="searchTerm"
                       placeholder="<?php echo e(__('Buscar ID, Paciente, Destino, Motivo...')); ?>"
            ...
            <div>
                ...
                <select wire:model.live="filterDateOption" id="filterDateOption" title="<?php echo e(__('Filtrar por data de')); ?>"
                        class="block w-full rounded-md border-gray-300 dark:border-neutral-600 py-1.5 pl-3 pr-8 text-sm text-gray-700 dark:text-neutral-200 bg-white dark:bg-neutral-700 shadow-sm focus:border-indigo-500 dark:focus:border-sky-500 focus:ring-1 focus:ring-indigo-500 dark:focus:ring-sky-500">
                    <option value=""><?php echo e(__('Período...')); ?></option>
            ...
            <!--[if BLOCK]><![endif]--><?php if($filterDateOption): ?>
                <div class="col-span-1 sm:col-span-2 md:col-span-3 lg:col-span-5 xl:col-span-6 grid grid-cols-1 sm:grid-cols-2 gap-3 mt-2">
                    <div>
                        <label for="filterStartDate" class="block text-xs font-medium text-gray-500 dark:text-neutral-400"><?php echo e(__('Data Início')); ?></label>
                    ...
                    <div>
                        <label for="filterEndDate" class="block text-xs font-medium text-gray-500 dark:text-neutral-400"><?php echo e(__('Data Fim')); ?></label>
                    ...
                    <div class="sm:flex sm:items-start">
                        ...
                        <div class="mt-3 text-center sm:mt-0 sm:ml-4 sm:text-left">
                            ...
                            <div class="mt-2">
                                ...
                                <div class="mt-3">
                                    <label for="cancellationReasonInput" class="block text-sm font-medium text-gray-700 dark:text-neutral-300"><?php echo e(__('Motivo do Cancelamento')); ?> <span class="text-red-500">*</span></label>
...
unset($__errorArgs, $__bag); ?><!--[if ENDBLOCK]><![endif]-->
                                ...
                                <div class="mt-3">
                                    <label for="cancellationNotesInput" class="block text-sm font-medium text-gray-700 dark:text-neutral-300"><?php echo e(__('Notas Adicionais (Opcional)')); ?></label>
                                    <textarea wire:model="cancellationNotes" id="cancellationNotesInput" rows="2" placeholder="<?php echo e(__('Ex: Cancelado por...')); ?>"
                                              class="mt-1 block w-full rounded-md border-gray-300 dark:border-neutral-600 py-2 px-3 bg-white dark:bg-neutral-700 text-gray-900 dark:text-neutral-100 shadow-sm focus:border-indigo-500 dark:focus:border-sky-500 focus:ring-1 focus:ring-indigo-500 dark:focus:ring-sky-500 <?php $__errorArgs = ['cancellationNotes'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> border-red-500 dark:border-red-400 <?php unset($message);
...
unset($__errorArgs, $__bag); ?>"></textarea>
                                    <!--[if BLOCK]><![endif]--><?php $__errorArgs = ['cancellationNotes'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> <p class="mt-1 text-xs text-red-600 dark:text-red-400"><?php echo e($message); ?></p> <?php unset($message);
...
unset($__errorArgs, $__bag); ?><!--[if ENDBLOCK]><![endif]-->
                                ...
                                <p class="mt-2 text-xs text-gray-500 dark:text-neutral-400">
                                    <?php echo e(__('A solicitação será marcada como cancelada e não poderá ser revertida facilmente.')); ?>
    ...
    <?php endif; ?><!--[if ENDBLOCK]><![endif]-->
</div><?php /**PATH /var/www/html/sabio-system/resources/views/livewire/travel-requests/index-travel-request.blade.php ENDPATH**/ ?>