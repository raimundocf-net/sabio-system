        ...
        <div class="bg-white dark:bg-neutral-800 shadow-xl sm:rounded-lg">
            <div class="p-6">
                ...
                <form wire:submit.prevent="searchCitizen" class="space-y-4">
                    <div>
                        <label for="search" class="block text-sm font-medium leading-6 text-gray-900 dark:text-neutral-200"><?php echo e(__('Nome, CPF ou CNS do Cidadão')); ?></label>
                        <div class="mt-2">
...
unset($__errorArgs, $__bag); ?><!--[if ENDBLOCK]><![endif]-->
                            ...
                            <div class="-mx-4 -my-2 overflow-x-auto sm:-mx-6 lg:-mx-8">
                                <div class="inline-block min-w-full py-2 align-middle sm:px-6 lg:px-8">
                                    <table class="min-w-full divide-y divide-gray-300 dark:divide-neutral-700">
                                        <thead>
                                        <tr>
                                            <th scope="col" class="py-3.5 pl-4 pr-3 text-left text-sm font-semibold text-gray-900 dark:text-neutral-100 sm:pl-0"><?php echo e(__('Nome')); ?></th>
                                            <th scope="col" class="px-3 py-3.5 text-left text-sm font-semibold text-gray-900 dark:text-neutral-100"><?php echo e(__('CPF')); ?></th>
                                            <th scope="col" class="px-3 py-3.5 text-left text-sm font-semibold text-gray-900 dark:text-neutral-100"><?php echo e(__('CNS')); ?></th>
                                            <th scope="col" class="px-3 py-3.5 text-left text-sm font-semibold text-gray-900 dark:text-neutral-100"><?php echo e(__('Mãe')); ?></th>
                                            <th scope="col" class="px-3 py-3.5 text-left text-sm font-semibold text-gray-900 dark:text-neutral-100"><?php echo e(__('Nascimento')); ?></th>
                                        ...
                                        <!--[if BLOCK]><![endif]--><?php $__currentLoopData = $results; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $citizen): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                            <tr wire:key="citizen-<?php echo e($citizen->id); ?>">
                                                <td class="whitespace-nowrap py-4 pl-4 pr-3 text-sm font-medium text-gray-900 dark:text-neutral-100 sm:pl-0"><?php echo e($citizen->name); ?></td>
                                                <td class="whitespace-nowrap px-3 py-4 text-sm text-gray-500 dark:text-neutral-300"><?php echo e($citizen->cpf ?: '-'); ?></td>
                                                <td class="whitespace-nowrap px-3 py-4 text-sm text-gray-500 dark:text-neutral-300"><?php echo e($citizen->cns ?: '-'); ?></td>
                                                <td class="whitespace-nowrap px-3 py-4 text-sm text-gray-500 dark:text-neutral-300"><?php echo e($citizen->name_mother ?: '-'); ?></td>
                                                <td class="whitespace-nowrap px-3 py-4 text-sm text-gray-500 dark:text-neutral-300"><?php echo e($citizen->date_of_birth ? \Carbon\Carbon::parse($citizen->date_of_birth)->format('d/m/Y') : '-'); ?></td>
                                                <td class="relative whitespace-nowrap py-4 pl-3 pr-4 text-right text-sm font-medium sm:pr-0">
                                                    
                                                    <a href="<?php echo e(route('travel-requests.create.form', ['citizen' => $citizen->id])); ?>" wire:navigate
                ...
                <?php elseif($results && $results->isEmpty() && (!empty($search) || !empty($searchMother))): ?>
                    <div class="border-t dark:border-neutral-700 pt-6 mt-6">
...
</div><?php /**PATH /var/www/html/system/resources/views/livewire/travel-requests/search-citizen-for-travel-step.blade.php ENDPATH**/ ?>