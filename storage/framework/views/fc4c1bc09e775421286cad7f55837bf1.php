<div>
    ...
    <div class="space-y-6">
        ...
        <div class="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4">
            ...
            <a href="<?php echo e(route('units.create')); ?>" wire:navigate
                ...
                <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); if ($__empty_1): ?>
                    <tr>
                        <td colspan="4" class="px-6 py-4 text-center text-sm text-neutral-500 dark:text-neutral-400">
                            <?php echo e(__('Nenhuma unidade encontrada.')); ?>
        ...
        <!--[if BLOCK]><![endif]--><?php if($units->hasPages()): ?>
            <div class="px-2 py-2">
        ...
        <!--[if BLOCK]><![endif]--><?php if($showDeleteModal && $deletingUnit): ?>
                            ...
                            <div class="sm:flex sm:items-start">
                                ...
                                <div class="mt-3 text-center sm:mt-0 sm:ml-4 sm:text-left">
                                    <h3 class="text-lg leading-6 font-medium text-gray-900 dark:text-neutral-100" id="modal-title">
                                        <?php echo e(__('Confirmar Exclusão')); ?>

                                    </h3>
                                    <div class="mt-2">
                                        <p class="text-sm text-gray-600 dark:text-neutral-300">
                                            <?php echo e(__('Você tem certeza que deseja excluir a unidade')); ?> <strong><?php echo e($deletingUnit->name); ?></strong>?
...
</div><?php /**PATH /var/www/html/system/resources/views/livewire/units/index.blade.php ENDPATH**/ ?>