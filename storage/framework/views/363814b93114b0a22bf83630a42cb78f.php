            ...
            <div class="bg-white dark:bg-neutral-800 shadow-xl rounded-lg overflow-hidden">
                <div class="px-6 py-5 border-b border-gray-200 dark:border-neutral-700">
                    <div class="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-3">
                        <h1 class="text-xl font-semibold text-gray-800 dark:text-neutral-100 inline-flex items-center gap-3">
                            <span class="icon-[mdi--map-marker-plus-outline] w-6 h-6 text-indigo-600 dark:text-sky-500"></span>
                            <?php echo e($pageTitle); ?>
                ...
                <form wire:submit.prevent="save">
                    <div class="p-6 sm:p-8 space-y-6">
                        <div>
                            <label for="name" class="block text-sm font-medium leading-6 text-gray-900 dark:text-neutral-200"><?php echo e(__('Nome do Local')); ?> <span class="text-red-500">*</span></label>
                            <div class="mt-2">
...
unset($__errorArgs, $__bag); ?><!--[if ENDBLOCK]><![endif]-->
                        ...
                        <div>
                            <label for="address" class="block text-sm font-medium leading-6 text-gray-900 dark:text-neutral-200"><?php echo e(__('Endereço/Ponto de Referência (Opcional)')); ?></label>
                            <div class="mt-2">
...
unset($__errorArgs, $__bag); ?><!--[if ENDBLOCK]><![endif]-->
                        ...
                        <div class="relative flex items-start">
                            ...
                            <div class="ml-3 text-sm leading-6">
                                <label for="is_active" class="font-medium text-gray-900 dark:text-neutral-200"><?php echo e(__('Ativo?')); ?></label>
                    ...
                    <div class="px-6 py-4 bg-gray-100 dark:bg-neutral-900 border-t border-gray-200 dark:border-neutral-700 flex items-center justify-end gap-x-4">
                        ...
                        <button type="submit" wire:loading.attr="disabled" wire:target="save"
                            ...
                            <span wire:loading.remove wire:target="save">
                                <span class="icon-[mdi--content-save] w-5 h-5 mr-1.5"></span>
                                <?php echo e(__('Salvar Local')); ?>
...
</div><?php /**PATH /var/www/html/system/resources/views/livewire/boarding-locations/create-boarding-location.blade.php ENDPATH**/ ?>