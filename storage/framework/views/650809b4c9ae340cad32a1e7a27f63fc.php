                            ...
                            <section aria-labelledby="patient-info-heading" class="bg-slate-50 dark:bg-neutral-700/30 p-5 rounded-md border border-slate-200 dark:border-neutral-700">
                                ...
                                <div class="text-sm">
                                    <p class="text-gray-700 dark:text-neutral-200">
                                        <strong class="font-medium"><?php echo e(__('Nome:')); ?></strong> <?php echo e($selectedCitizen->name); ?>

                                    </p>
                                    <p class="text-xs text-gray-500 dark:text-neutral-400 mt-1">
                                        CPF: <?php echo e($selectedCitizen->cpf ?? __('N/D')); ?> | CNS: <?php echo e($selectedCitizen->cns ?? __('N/D')); ?> | Nasc: <?php echo e($selectedCitizen->date_of_birth ? \Carbon\Carbon::createFromFormat('d/m/Y', $selectedCitizen->date_of_birth)->format('d/m/Y') : __('N/D')); ?>
