                ...
                <div class="p-4 sm:p-6 space-y-6">
                    ...
                    <!--[if BLOCK]><![endif]--><?php if($selectedCitizen): ?>
                        <fieldset class="border dark:border-neutral-700 p-4 rounded-md">
                            <legend class="text-md font-semibold text-gray-700 dark:text-neutral-200 px-2"><?php echo e(__('1. Paciente Selecionado')); ?></legend>
                            <div class="mt-2 space-y-1 text-sm">
                                <p class="text-gray-800 dark:text-neutral-100"><strong><?php echo e(__('Nome:')); ?></strong> <?php echo e($selectedCitizen->name); ?></p>
                                <p class="text-xs text-gray-600 dark:text-neutral-300">CPF: <?php echo e($selectedCitizen->cpf ?? __('N/D')); ?> | CNS: <?php echo e($selectedCitizen->cns ?? __('N/D')); ?> | Nasc: <?php echo e($selectedCitizen->date_of_birth ? \Carbon\Carbon::parse($selectedCitizen->date_of_birth)->format('d/m/Y') : __('N/D')); ?></p>
                            </div>
                        </fieldset>
                    <?php else: ?>
                        <div class="p-4 border border-red-300 bg-red-50 dark:bg-red-800/30 dark:border-red-600 rounded-md text-red-700 dark:text-red-300">
                            <?php echo e(__('Nenhum cidadão selecionado. Por favor, volte e selecione um cidadão.')); ?>
                    ...
                    <!--[if BLOCK]><![endif]--><?php if($selectedCitizen): ?>
                        <fieldset class="border dark:border-neutral-700 p-4 rounded-md mt-4">
                            <legend class="text-md font-semibold text-gray-700 dark:text-neutral-200 px-2"><?php echo e(__('2. Detalhes da Viagem')); ?></legend>
                            <div class="mt-4 space-y-5">
                                <?php echo $__env->make('livewire.travel-requests.search-citizen-for-travel-step', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?>
                            </div>
                        </fieldset>

                        <fieldset class="border dark:border-neutral-700 p-4 rounded-md mt-4">
                            <legend class="text-md font-semibold text-gray-700 dark:text-neutral-200 px-2"><?php echo e(__('3. Acompanhante e Passageiros')); ?></legend>
                            <div class="mt-4 space-y-5">
                                <div class="flex items-start">
                                    ...
                                    <div class="ml-3 rtl:ml-0 rtl:mr-3 text-sm">
                                        <label for="needs_companion_form" class="font-medium text-gray-700 dark:text-neutral-300"><?php echo e(__('Precisa de Acompanhante?')); ?></label>
                                    </div>
                                </div>
...
unset($__errorArgs, $__bag); ?><!--[if ENDBLOCK]><![endif]-->
                                        ...
                                        <div>
                                            <label for="companion_cpf_form" class="block text-sm font-medium text-gray-700 dark:text-neutral-300"><?php echo e(__('CPF do Acompanhante')); ?></label>
                                            <input type="text" wire:model.defer="form.companion_cpf" id="companion_cpf_form" placeholder="000.000.000-00"
                                                   class="mt-1 block w-full rounded-md border-gray-300 dark:border-neutral-600 py-2.5 px-3 bg-white dark:bg-neutral-700 text-gray-900 dark:text-neutral-100 shadow-sm focus:border-indigo-500 dark:focus:border-sky-500 focus:ring-1 focus:ring-indigo-500 dark:focus:ring-sky-500 <?php $__errorArgs = ['form.companion_cpf'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> border-red-500 dark:border-red-400 <?php unset($message);
...
unset($__errorArgs, $__bag); ?><!--[if ENDBLOCK]><![endif]-->
                                ...
                                <?php endif; ?><!--[if ENDBLOCK]><![endif]-->
                                <div>
                                    <label for="number_of_passengers_form" class="block text-sm font-medium text-gray-700 dark:text-neutral-300"><?php echo e(__('Número Total de Passageiros')); ?> <span class="text-red-500">*</span></label>
                                    <input type="number" wire:model.defer="form.number_of_passengers" id="number_of_passengers_form" min="1"
                                           class="mt-1 block w-full sm:w-1/3 rounded-md border-gray-300 dark:border-neutral-600 py-2.5 px-3 bg-white dark:bg-neutral-700 text-gray-900 dark:text-neutral-100 shadow-sm focus:border-indigo-500 dark:focus:border-sky-500 focus:ring-1 focus:ring-indigo-500 dark:focus:ring-sky-500 <?php $__errorArgs = ['form.number_of_passengers'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> border-red-500 dark:border-red-400 <?php unset($message);
...
unset($__errorArgs, $__bag); ?><!--[if ENDBLOCK]><![endif]-->
                        ...
                        <fieldset class="border dark:border-neutral-700 p-4 rounded-md mt-4">
                            <legend class="text-md font-semibold text-gray-700 dark:text-neutral-200 px-2"><?php echo e(__('4. Documentação e Observações')); ?></legend>
                            <div class="mt-4 space-y-5">
                                <?php echo $__env->make('livewire.travel-requests.search-citizen-for-travel-step', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?>
                            </div>
                        </fieldset>
                ...
                <!--[if BLOCK]><![endif]--><?php if($selectedCitizen): ?>
                    <div class="flex items-center justify-end gap-x-3 bg-gray-50 dark:bg-neutral-900/30 px-4 py-3 sm:px-6 border-t border-gray-200 dark:border-neutral-700 rounded-b-lg">
                        ...
                        <button type="submit" wire:loading.attr="disabled"
                            ...
                            <span wire:loading wire:target="save"><?php echo e(__('Salvando...')); ?></span>
                        </button>
                    </div>
                <?php endif; ?><!--[if ENDBLOCK]><![endif]-->
            </form>
...
</div><?php /**PATH /var/www/html/system/resources/views/livewire/travel-requests/travel-request-form-step.blade.php ENDPATH**/ ?>