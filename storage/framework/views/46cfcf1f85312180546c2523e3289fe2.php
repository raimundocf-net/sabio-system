        ...
        <div class="bg-white dark:bg-neutral-800 shadow-md sm:rounded-lg">
            ...
            <form wire:submit.prevent="updateUser">
                <div class="p-6">
                    ...
                    <?php echo $__env->make('livewire.users._form-user', ['isEditing' => true], array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?>
                </div>
                ...
                <div class="flex items-center justify-end space-x-3 bg-gray-50 dark:bg-neutral-800/50 px-6 py-4 border-t border-gray-200 dark:border-neutral-700 sm:rounded-b-lg">
                    ...
                    <button type="submit"
                        ...
                        <span wire:loading.remove wire:target="updateUser" class="icon-[mdi--content-save] w-4 h-4 mr-2"></span>
                        ...
                        <span wire:loading wire:target="updateUser"><?php echo e(__('Salvando...')); ?></span>
                        <span wire:loading.remove wire:target="updateUser"><?php echo e(__('Salvar Alterações')); ?></span>
                    </button>
                </div>
            </form>
        </div>
    </div>
</div><?php /**PATH /var/www/html/system/resources/views/livewire/users/update-user.blade.php ENDPATH**/ ?>