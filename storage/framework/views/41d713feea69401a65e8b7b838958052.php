            ...
            <div class="bg-white dark:bg-neutral-800 shadow-xl rounded-lg overflow-hidden">
                ...
                <form wire:submit.prevent="updateTravelRequest">
                    <div class="p-6 sm:p-8 space-y-8">
                        ...
                        <!--[if BLOCK]><![endif]--><?php if($travelRequest && $travelRequest->citizen): ?>
                            <section aria-labelledby="patient-info-heading" class="bg-slate-50 dark:bg-neutral-700/30 p-5 rounded-md border border-slate-200 dark:border-neutral-700">
                                <h2 id="patient-info-heading" class="text-lg font-semibold text-gray-800 dark:text-neutral-100 mb-3">
                                    <?php echo e(__('1. Paciente')); ?>

                                </h2>
                                <div class="text-sm">
                                    <p class="text-gray-700 dark:text-neutral-200">
                                        <strong class="font-medium"><?php echo e(__('Nome:')); ?></strong> <?php echo e($travelRequest->citizen->nome_do_cidadao); ?>

                                    </p>
                                    <p class="text-xs text-gray-500 dark:text-neutral-400 mt-1">
                                        CPF: <?php echo e($travelRequest->citizen->cpf ?? __('N/D')); ?> |
                                        CNS: <?php echo e($travelRequest->citizen->cns ?? __('N/D')); ?> |
                                        Idade: <?php echo e($travelRequest->citizen->idade ? : __('N/D')); ?>
                        ...
                        <?php else: ?>
                            <div class="p-4 border-l-4 border-red-500 bg-red-100 dark:bg-red-800/40 text-red-700 dark:text-red-300 rounded-md" role="alert">
                                <p class="font-medium"><?php echo e(__('Informações do cidadão não disponíveis ou inválidas para esta solicitação.')); ?></p>
                            </div>
                            ...
                            <section aria-labelledby="trip-details-heading" class="space-y-6 pt-6 border-t border-gray-300 dark:border-neutral-700">
                                ...
                                <div class="grid grid-cols-1 gap-x-6 gap-y-6 sm:grid-cols-6">
                                    ...
                                    <div class="sm:col-span-6">
                                        <label for="edit_form_reason" class="block text-sm font-medium leading-6 text-gray-900 dark:text-neutral-200"><?php echo e(__('Motivo/Propósito da Viagem')); ?> <span class="text-red-500">*</span></label>
                                        <div class="mt-2">
                                            <textarea wire:model.defer="form.reason" id="edit_form_reason" rows="3" placeholder="<?php echo e(__('Ex: Consulta com especialista, Exame de alta complexidade...')); ?>"
...
unset($__errorArgs, $__bag); ?><!--[if ENDBLOCK]><![endif]-->
                                    ...
                                    <div class="sm:col-span-3">
                                        <label for="edit_form_procedure_type" class="block text-sm font-medium leading-6 text-gray-900 dark:text-neutral-200"><?php echo e(__('Tipo de Procedimento')); ?> <span class="text-red-500">*</span></label>
                                        <div class="mt-2">
...
unset($__errorArgs, $__bag); ?><!--[if ENDBLOCK]><![endif]-->
                                    ...
                                    <div class="sm:col-span-3">
                                        <label for="edit_form_departure_location" class="block text-sm font-medium leading-6 text-gray-900 dark:text-neutral-200"><?php echo e(__('Local de Embarque')); ?> <span class="text-red-500">*</span></label>
                                        <div class="mt-2 flex items-center gap-x-2">
                                            <select wire:model="form.departure_location" id="edit_form_departure_location" 
...
unset($__errorArgs, $__bag); ?><!--[if ENDBLOCK]><![endif]-->
                                    ...
                                    <div class="sm:col-span-3">
                                        <label for="edit_form_destination_address" class="block text-sm font-medium leading-6 text-gray-900 dark:text-neutral-200"><?php echo e(__('Endereço de Destino')); ?> <span class="text-red-500">*</span></label>
                                        <div class="mt-2">
                                            <input type="text" wire:model.defer="form.destination_address" id="edit_form_destination_address" placeholder="<?php echo e(__('Rua, Número, Bairro, Complemento...')); ?>"
...
unset($__errorArgs, $__bag); ?><!--[if ENDBLOCK]><![endif]-->
                                    ...
                                    <div class="sm:col-span-2">
                                        <label for="edit_form_destination_city" class="block text-sm font-medium leading-6 text-gray-900 dark:text-neutral-200"><?php echo e(__('Cidade Destino')); ?> <span class="text-red-500">*</span></label>
                                        <div class="mt-2">
...
unset($__errorArgs, $__bag); ?><!--[if ENDBLOCK]><![endif]-->
                                    ...
                                    <div class="sm:col-span-1">
                                        <label for="edit_form_destination_state" class="block text-sm font-medium leading-6 text-gray-900 dark:text-neutral-200"><?php echo e(__('UF Destino')); ?> <span class="text-red-500">*</span></label>
                                        <div class="mt-2">
...
unset($__errorArgs, $__bag); ?>">
                                                ...
                                                <option value=""><?php echo e(__('Selecione UF')); ?></option>
...
unset($__errorArgs, $__bag); ?><!--[if ENDBLOCK]><![endif]-->
                                    ...
                                    <div class="sm:col-span-3">
                                        <label for="edit_form_desired_departure_datetime" class="block text-sm font-medium leading-6 text-gray-900 dark:text-neutral-200"><?php echo e(__('Previsão de Saída da Origem')); ?></label>
                                        <div class="mt-2">
...
unset($__errorArgs, $__bag); ?><!--[if ENDBLOCK]><![endif]-->
                                    ...
                                    <div class="sm:col-span-3">
                                        <label for="edit_form_appointment_datetime" class="block text-sm font-medium leading-6 text-gray-900 dark:text-neutral-200"><?php echo e(__('Data/Hora do Compromisso no Destino')); ?> <span class="text-red-500">*</span></label>
                                        <div class="mt-2">
                                ...
                                <div class="space-y-6">
                                    <div class="relative flex items-start">
                                        ...
                                        <div class="ml-3 text-sm leading-6">
                                            <label for="edit_needs_companion_form_input" class="font-medium text-gray-900 dark:text-neutral-200"><?php echo e(__('Precisa de Acompanhante?')); ?></label>
                                        </div>
                                    </div>
                                    ...
                                    <!--[if BLOCK]><![endif]--><?php if($form['needs_companion']): ?>
                                        <div class="grid grid-cols-1 gap-x-6 gap-y-6 sm:grid-cols-6">
                                            <div class="sm:col-span-3">
                                                <label for="edit_companion_name_form_input" class="block text-sm font-medium leading-6 text-gray-900 dark:text-neutral-200"><?php echo e(__('Nome do Acompanhante')); ?> <span class="text-red-500">*</span></label>
                                                <div class="mt-2">
...
unset($__errorArgs, $__bag); ?><!--[if ENDBLOCK]><![endif]-->
                                            ...
                                            <div class="sm:col-span-3">
                                                <label for="edit_companion_cpf_form_input" class="block text-sm font-medium leading-6 text-gray-900 dark:text-neutral-200"><?php echo e(__('CPF do Acompanhante (Opcional)')); ?></label>
                                                <div class="mt-2">
...
unset($__errorArgs, $__bag); ?><!--[if ENDBLOCK]><![endif]-->
                                    ...
                                    <?php endif; ?><!--[if ENDBLOCK]><![endif]-->
                                    <div class="sm:col-span-2"> 
                                        <label for="edit_number_of_passengers_form_input" class="block text-sm font-medium leading-6 text-gray-900 dark:text-neutral-200"><?php echo e(__('Número Total de Passageiros')); ?> <span class="text-red-500">*</span></label>
                                        <div class="mt-2">
...
unset($__errorArgs, $__bag); ?><!--[if ENDBLOCK]><![endif]-->
                                        ...
                                        <?php elseif($form['referral_document_path'] ?? null): ?>
                                            <div class="mt-3">
                                                <p class="text-xs font-medium text-gray-700 dark:text-neutral-300 mb-1"><?php echo e(__('Guia Anexada Atualmente:')); ?></p>
                                    ...
                                    <div>
                                        <label for="edit_observations_form" class="block text-sm font-medium leading-6 text-gray-900 dark:text-neutral-200"><?php echo e(__('Observações Gerais da Atendente')); ?></label>
                                        <div class="mt-2">
                                            <textarea wire:model.defer="form.observations" id="edit_observations_form" rows="4" placeholder="<?php echo e(__('Informações adicionais sobre a necessidade da viagem, restrições do paciente, etc...')); ?>"
...
unset($__errorArgs, $__bag); ?><!--[if ENDBLOCK]><![endif]-->
                            ...
                            <section aria-labelledby="management-heading-edit" class="space-y-6 pt-6 border-t border-gray-300 dark:border-neutral-700">
                                <h2 id="management-heading-edit" class="text-lg font-semibold leading-7 text-gray-900 dark:text-neutral-100">
                                    <?php echo e(__('5. Gerenciamento da Viagem')); ?>

                                </h2>
                                <div class="grid grid-cols-1 gap-x-6 gap-y-6 sm:grid-cols-6">
                                    <div class="sm:col-span-3">
                                        <label for="edit_form_status" class="block text-sm font-medium leading-6 text-gray-900 dark:text-neutral-200"><?php echo e(__('Status da Solicitação')); ?></label>
                                        <div class="mt-2">
                                            <select wire:model.defer="form.status" id="edit_form_status"
                                                    class="block w-full rounded-md border-0 py-2.5 pl-3 pr-10 text-gray-900 dark:text-neutral-100 bg-white dark:bg-neutral-700 shadow-sm ring-1 ring-inset ring-gray-300 dark:ring-neutral-600 focus:ring-2 focus:ring-inset focus:ring-indigo-600 dark:focus:ring-sky-500 sm:text-sm sm:leading-6 <?php $__errorArgs = ['form.status'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
...
unset($__errorArgs, $__bag); ?>">
                                                ...
                                                <!--[if BLOCK]><![endif]--><?php if(!empty($statusOptions)): ?> 
    ...
    <!--[if BLOCK]><![endif]--><?php if($showAddBoardingLocationModal): ?>
        <div class="fixed inset-0 z-[100] flex items-center justify-center p-4"
            ...
            <div class="bg-white dark:bg-neutral-800 rounded-lg shadow-xl transform transition-all sm:max-w-lg w-full p-6 space-y-4"
                ...
                <div>
                    <label for="newBoardingLocationName_edit" class="block text-sm font-medium text-gray-700 dark:text-neutral-300"><?php echo e(__('Nome do Local')); ?> <span class="text-red-500">*</span></label>
...
unset($__errorArgs, $__bag); ?><!--[if ENDBLOCK]><![endif]-->
                ...
                <div>
                    <label for="newBoardingLocationAddress_edit" class="block text-sm font-medium text-gray-700 dark:text-neutral-300"><?php echo e(__('Endereço/Ponto de Referência (Opcional)')); ?></label>
...
</div><?php /**PATH /var/www/html/sabio-system/resources/views/livewire/travel-requests/edit-travel-request.blade.php ENDPATH**/ ?>