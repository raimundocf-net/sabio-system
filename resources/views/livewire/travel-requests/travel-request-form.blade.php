                    ...
                    <div class="p-6 sm:p-8 space-y-8">
                        ...
                        @else
                            <div class="p-4 border-l-4 border-red-500 bg-red-100 dark:bg-red-800/40 text-red-700 dark:text-red-300 rounded-md" role="alert">
                                <p class="font-medium">{{ __('Nenhum cidadão selecionado.') }}
                                    <a href="{{route('travel-requests.create.search-citizen')}}" wire:navigate class="font-semibold hover:underline">{{__('Por favor, volte e selecione um cidadão.')}}</a>
                                </p>
                            </div>
                        @endif
                        ...
                        @if($selectedCitizen)
                            ...
                            <section aria-labelledby="trip-details-heading" class="space-y-6 pt-6 border-t border-gray-300 dark:border-neutral-700">
                                ...
                                <div class="grid grid-cols-1 gap-x-6 gap-y-6 sm:grid-cols-6">
                                    <div class="sm:col-span-6">
                                        <label for="form_reason" class="block text-sm font-medium leading-6 text-gray-900 dark:text-neutral-200">{{__('Motivo/Propósito da Viagem')}} <span class="text-red-500">*</span></label>
                                        <div class="mt-2">
                                    ...
                                    <div class="sm:col-span-3">
                                        <label for="form_procedure_type" class="block text-sm font-medium leading-6 text-gray-900 dark:text-neutral-200">{{__('Tipo de Procedimento')}} <span class="text-red-500">*</span></label>
                                        <div class="mt-2">
                                    ...
                                    <div class="sm:col-span-2">
                                        <label for="form_destination_city" class="block text-sm font-medium leading-6 text-gray-900 dark:text-neutral-200">{{__('Cidade Destino')}} <span class="text-red-500">*</span></label>
                                        <div class="mt-2">
                                    ...
                                    <div class="sm:col-span-1">
                                        <label for="form_destination_state" class="block text-sm font-medium leading-6 text-gray-900 dark:text-neutral-200">{{__('UF Destino')}} <span class="text-red-500">*</span></label>
                                        <div class="mt-2">
                                    ...
                                    <div class="sm:col-span-3">
                                        <label for="form_desired_departure_datetime" class="block text-sm font-medium leading-6 text-gray-900 dark:text-neutral-200">{{__('Previsão de Saída da Origem')}}</label>
                                        <div class="mt-2">
                                    ...
                                    <div class="sm:col-span-3">
                                        <label for="form_appointment_datetime" class="block text-sm font-medium leading-6 text-gray-900 dark:text-neutral-200">{{__('Data/Hora do Compromisso no Destino')}} <span class="text-red-500">*</span></label>
                                        <div class="mt-2">
                                ...
                                <div class="space-y-6">
                                    <div class="relative flex items-start">
                                        ...
                                        <div class="ml-3 text-sm leading-6">
                                            <label for="needs_companion_form_input" class="font-medium text-gray-900 dark:text-neutral-200">{{__('Precisa de Acompanhante?')}}</label>
                                        </div>
                                    </div>
                                    ...
                                    @if($form['needs_companion'])
                                        <div class="grid grid-cols-1 gap-x-6 gap-y-6 sm:grid-cols-6">
                                            <div class="sm:col-span-3">
                                                <label for="companion_name_form_input" class="block text-sm font-medium leading-6 text-gray-900 dark:text-neutral-200">{{__('Nome do Acompanhante')}} <span class="text-red-500">*</span></label>
                                                <div class="mt-2">
                                            ...
                                            <div class="sm:col-span-3">
                                                <label for="companion_cpf_form_input" class="block text-sm font-medium leading-6 text-gray-900 dark:text-neutral-200">{{__('CPF do Acompanhante (Opcional)')}}</label>
                                                <div class="mt-2">
                            ...
                            <section aria-labelledby="docs-obs-heading" class="space-y-6 pt-6 border-t border-gray-300 dark:border-neutral-700">
                                ...
                                <div class="space-y-6">
                                    ...
                                    <div>
                                        <label for="observations_form" class="block text-sm font-medium leading-6 text-gray-900 dark:text-neutral-200">{{__('Observações Gerais da Atendente')}}</label>
                                        <div class="mt-2">
                                            <textarea wire:model.defer="form.observations" id="observations_form" rows="4" placeholder="{{__('Informações adicionais sobre a necessidade da viagem, restrições do paciente, etc...')}}"
