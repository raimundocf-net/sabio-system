            ...
            <div class="bg-white dark:bg-neutral-800 shadow-xl rounded-lg overflow-hidden">
                ...
                <form wire:submit.prevent="save">
                    <div class="p-6 sm:p-8 space-y-6">
                        <div>
                            <label for="name" class="block text-sm font-medium leading-6 text-gray-900 dark:text-neutral-200">{{__('Nome do Local')}} <span class="text-red-500">*</span></label>
                            <div class="mt-2">
                        ...
                        <div>
                            <label for="address" class="block text-sm font-medium leading-6 text-gray-900 dark:text-neutral-200">{{__('Endereço/Ponto de Referência (Opcional)')}}</label>
                            <div class="mt-2">
                        ...
                        <div class="relative flex items-start">
                            ...
                            <div class="ml-3 text-sm leading-6">
                                <label for="is_active" class="font-medium text-gray-900 dark:text-neutral-200">{{__('Ativo?')}}</label>
                    ...
                    <div class="px-6 py-4 bg-gray-100 dark:bg-neutral-900 border-t border-gray-200 dark:border-neutral-700 flex items-center justify-end gap-x-4">
                        ...
                        <button type="submit" wire:loading.attr="disabled" wire:target="save"
                            ...
                            <span wire:loading.remove wire:target="save">
                                ...
                                {{ $isEditing ? __('Atualizar Local') : __('Salvar Local') }}
                            </span>
